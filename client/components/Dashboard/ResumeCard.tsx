            ...
            <Link href={`/dashboard/resumes/${resume.id}`} className="block">
                <div className="px-4 py-5 sm:p-6">
                    <div className="flex items-center justify-between mb-4">
                        <h4 className="text-lg font-semibold text-white truncate">{resume.fullname}</h4>
                        <div className="flex space-x-2">
                            <span className="px-2 py-1 text-xs font-medium rounded-full bg-background text-white">
                    ...
                    <div className="space-y-3">
                            ...
                            <div className="mt-3">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    {resume.skills.length > 3 && (
                                        <span className="px-2 py-1 text-xs font-medium rounded-full bg-gray-100 text-white">
                        ...
                        {resume.educations && resume.educations.length > 0 && (
                            <div className="mt-3">
                                <h5 className="text-sm font-bold text-white mb-2">Education</h5>
                                ...
                                <div className="space-y-2">
                                    {resume.careers.slice(0, 2).map((career, index) => (
                                        <div key={index} className="text-sm text-white">
                                            ...
                                            <div className="text-white">{career.employer}</div>
                                        </div>
                                    ))}
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-200">
                            <p className="text-sm text-white line-clamp-2">{resume.summary}</p>
                        </div>
                    </div>
                </div>
            </Link>
